...
HipAllreduceRing<T, W>::HipAllreduceRing(
...
template <typename T, typename W>
template <typename U>
void HipAllreduceRing<T, W>::init(
...
template class HipAllreduceRing<T, HipHostWorkspace<T> >;             \
template class HipAllreduceRing<T, HipDeviceWorkspace<T> >;
