...
struct HipAllreduceRingChunked<T, W>::ChunkContext {
  ChunkContext(
...
template <typename T, typename W>
HipAllreduceRingChunked<T, W>::HipAllreduceRingChunked(
...
template <typename T, typename W>
void HipAllreduceRingChunked<T, W>::run() {
...
template <typename T, typename W>
int HipAllreduceRingChunked<T, W>::getChunkOffset(int round) {
...
template <typename T, typename W>
void HipAllreduceRingChunked<T, W>::copyChunkAtOffset(int chunkOffset) {
...
template <typename T, typename W>
template <typename U>
void HipAllreduceRingChunked<T, W>::init(
...
template class HipAllreduceRingChunked<T, HipHostWorkspace<T> >;      \
template class HipAllreduceRingChunked<T, HipDeviceWorkspace<T> >;
