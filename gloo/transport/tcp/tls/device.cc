...
const std::string& Device::getPKeyFile() const {
  return pkey_file_;
}

const std::string& Device::getCertFile() const {
  return cert_file_;
}

const std::string& Device::getCAFile() const {
  return ca_file_;
}

const std::string& Device::getCAPath() const {
  return ca_path_;
}
